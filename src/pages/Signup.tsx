    ...
    <div className="flex justify-center items-center py-20 px-6">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-[10px] font-black text-indigo-400 uppercase tracking-[0.3em] mb-2 leading-none">Registration Node</p>
          <h2 className="text-3xl font-black text-white tracking-tighter uppercase">INITIALIZE PROFILE</h2>
        </div>

        <form onSubmit={handleSignup} className="space-y-6">
          <div className="space-y-2 text-left">
            <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest pl-1 leading-none">Full Name</label>
            <div className="relative">
              <User className="absolute left-4 top-4 h-4 w-4 text-slate-600" />
              <input 
                type="text" 
                required
          ...
          <div className="space-y-2 text-left">
            <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest pl-1 leading-none">Secure Access Key</label>
            <div className="relative">
